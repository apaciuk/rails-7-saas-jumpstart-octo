...
(For less opinionated slightly more bare bones version for quick MVP's, tests and projects, with UUIDs, User Roles, Rack Contrib, RSpec/Rubocop & Puma webserver,
